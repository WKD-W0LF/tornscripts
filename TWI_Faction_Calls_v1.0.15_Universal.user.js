...
(function () {
  ...
  function mountSettingsPanel(panel) {
    // Mirror TWSE exactly — works on desktop, tablet and mobile:
    // War tab active  → #faction_war_list_id is in the DOM → show panel after TWSE or war list
    // Any other tab   → #faction_war_list_id absent        → remove panel so it doesn't
    //                   bleed into/behind Rank, Info, etc. tab content
    ...
    if (warList) {
      ...
      // Not on War tab — remove so it doesn't show behind other tab panels
