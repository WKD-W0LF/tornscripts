...
(function () {
  ...
  // Place the panel into the page. Called repeatedly until it sticks.
  function mountSettingsPanel(panel) {
    ...
    // 2. After #faction_war_list_id — always in DOM on faction page, all platforms
  ...
  function injectSettingsPanel() {
    ...
    // Always try to mount/reposition
