...
(function () {
  ...
  GM_addStyle(`
    ...
    /* Give .member a stacking context so absolute children clip to it */
    .members-list li .member{position:relative!important;overflow:visible!important;min-width:0}

    /* The control sits below the name in normal flow on mobile,
       and is absolutely positioned at the bottom of the cell on desktop/tablet
       so it never adds height to the row. */
    .twi-call-control{
      display:inline-flex;align-items:center;gap:4px;
      font-family:Arial,sans-serif;font-size:10px;line-height:1.1;
    ...
    .twi-call-main{
      ...
      min-width:52px;height:20px;padding:2px 5px;
      background:rgba(20,20,20,.82);color:#fff;white-space:nowrap;
    ...
    .twi-call-meta{
      ...
      font-weight:700;color:var(--default-color,#ddd);font-size:9px
    }
    ...
    .twi-flag{
      ...
      border-color:rgba(255,255,255,.18);border-radius:4px
    }
    .twi-flag-icon{display:block;width:12px;height:12px;fill:currentColor;pointer-events:none}
    ...
    /* ── Mobile (up to 900px): control flows below name in normal document flow ── */
    @media(max-width:900px){
      ...
      .twi-call-main{
        min-width:68px!important;width:auto!important;
      ...
      .twi-call-meta{
        ...
        max-width:60px!important;font-size:9px!important;
    ...
    /* ── Tablet + Desktop (901px+): control is absolutely positioned inside .member,
          anchored bottom-left, so it overlays the cell without expanding the row. ── */
    @media(min-width:901px){
      ...
      .twi-call-main{
        min-width:52px!important;height:18px!important;min-height:18px!important;
      ...
      .twi-call-meta{max-width:80px!important;font-size:9px!important}
