...
(function () {
  ...
  GM_addStyle(`
    ...
    /* ── Mobile (up to 900px): .member becomes a flex column, control flows below name ── */
    ...
    /* ── Tablet + Desktop (901px+):
          The li row gets extra bottom padding to make space.
          .member gets position:relative so the control can anchor to it.
          The control sits at top:100% of .member — directly below the name
          banner, horizontally clipped to the .member column width. ── */
